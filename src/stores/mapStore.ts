...
function axisAlignPath(nodes: Point[], mask: Uint8Array, width: number, height: number): Point[] {
...
function centerlinePath(wps: Point[], mask: Uint8Array, width: number, height: number): Point[] {
